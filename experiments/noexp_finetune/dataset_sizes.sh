...
python3 run.py --noexp-dataset-filepath ./dataset/crisis_dataset_size_1/noexp/ --percent-dataset 0.01
python3 run.py --exp-flag --exp-dataset-filepath ./dataset/crisis_dataset_size_1/exp/ --percent-dataset 0.01
...
python3 run.py --noexp-dataset-filepath ./dataset/crisis_dataset_size_10/noexp/  --percent-dataset 0.1
python3 run.py --exp-flag --exp-dataset-filepath ./dataset/crisis_dataset_size_10/exp/  --percent-dataset 0.1
...
python3 run.py --noexp-dataset-filepath ./dataset/crisis_dataset_size_50/noexp/ --percent-dataset 0.5
python3 run.py --exp-flag --exp-dataset-filepath ./dataset/crisis_dataset_size_50/exp/  --percent-dataset 0.5
...
python3 run.py --noexp-dataset-filepath ./dataset/crisis_dataset_size_75/noexp/ --percent-dataset 0.75
python3 run.py --exp-flag --exp-dataset-filepath ./dataset/crisis_dataset_size_75/exp/  --percent-dataset 0.75
