...
python3 classifier.py --exp-flag --exp-embeddings-filepath ./embeddings/exp_random_bert-base-cased_embeddings.pt --exp-dataset-filepath ./dataset/crisis_dataset_random/exp/
