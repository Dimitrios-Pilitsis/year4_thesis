...
python3 classifier.py --exp-flag --percent-dataset 0.1 --num-epochs 400
...
python3 classifier.py --exp-flag --percent-dataset 0.25 --num-epochs 400
...
python3 classifier.py --exp-flag --percent-dataset 0.5 --num-epochs 400
...
python3 classifier.py --exp-flag --percent-dataset 0.75 --num-epochs 400
