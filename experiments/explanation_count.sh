...
python3 create_embeddings.py --exp-flag --exp-dataset-filepath ./dataset/crisis_dataset_few/exp/ --split-value 150
python3 classifier.py --exp-flag --exp-embeddings-filepath ./embeddings/exp_few_bert-base-cased_embeddings.pt --exp-dataset-filepath ./dataset/crisis_dataset_few/exp/ --num-epochs 400
...
python3 classifier.py --exp-flag --exp-embeddings-filepath ./embeddings/exp_many_bert-base-cased_embeddings.pt --exp-dataset-filepath ./dataset/crisis_dataset_many/exp/ --num-epochs 400
